    ...
    <div className="bg-sand-50">
      <section className="relative isolate flex min-h-[70svh] items-end overflow-hidden bg-sea-900 py-16 text-white md:items-center md:py-24">
        ...
        <div className="container-main">
          ...
          <h1 className="mt-4 max-w-3xl text-5xl font-extrabold leading-none sm:text-6xl md:text-7xl">{ar ? 'خدمة الإيجار قادمة قريباً.' : 'Rentals are coming soon.'}</h1>
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/75">{ar ? 'لسه ما أطلقناش منتجات أو مخزون للإيجار. هنعلن عن الخدمة لما تكون جاهزة.' : 'No rental products or inventory have launched yet. We will announce the service when it is ready.'}</p>
